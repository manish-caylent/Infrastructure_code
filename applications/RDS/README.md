...
| <a name="module_sg"></a> [sg](#module\_sg) | ./modules/db_security_group | n/a |

## Resources

| Name | Type |
|------|------|
| [random_id.deploymentID](https://registry.terraform.io/providers/hashicorp/random/latest/docs/resources/id) | resource |
...
| <a name="input_cidr_blocks"></a> [cidr\_blocks](#input\_cidr\_blocks) | CIDR Value of the VPC | `string` | `""` | no |
...
| <a name="input_secret_name"></a> [secret\_name](#input\_secret\_name) | Secret ID of the credentials stored in AWS Secret Manager | `string` | `null` | no |
...
| <a name="input_vpc_id"></a> [vpc\_id](#input\_vpc\_id) | ID of the VPC created | `string` | `""` | no |
